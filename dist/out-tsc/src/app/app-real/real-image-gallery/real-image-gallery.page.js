...
var RealImageGalleryPage = /** @class */ (function () {
    ...
    RealImageGalleryPage = __decorate([
        Component({
            ...
            templateUrl: './real-image-gallery.page.html',
            styleUrls: ['./real-image-gallery.page.scss'],
        }),
        __metadata("design:paramtypes", [])
    ], RealImageGalleryPage);
    return RealImageGalleryPage;
}());
export { RealImageGalleryPage };
//# sourceMappingURL=real-image-gallery.page.js.map